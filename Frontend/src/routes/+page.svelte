...
<main
  class="bg-[url('../src/images/jimmy-chang-xnpq29vhHms-unsplash.jpg')] bg-cover bg-fixed !scroll-smooth pb-6"
>
  <section id="First" class="flex justify-center h-screen items-center">
    <div class="sm:card w-full sm:max-w-lg shadow-xl glass">
      <div class="card-body items-center text-center">
        <h2 class="text-4xl font-bold card-title text-white w-128">
          Transform the way you manage energy.
        </h2>
        <br />
        <div class="card-actions">
          {#if loggedIn}
            <a class="btn btn-outline text-xl text-white" href="/Main/Dashboard"
              >Dashboard</a
            >
          {:else}
            <a class="btn btn-outline text-xl text-white" href="/login"
              >Sign in</a
            >
          {/if}
          <a
            class="btn btn-outline text-xl text-white"
        ...
        <div
          class="flex flex-col w-max justify-center items-center"
          on:click={scrollDown}
        >
      ...
      <div class="sm:basis-5/6 flex-row mx-4">
        ...
        >
          ...
          <div class="card-body text-white">
            ...
            <p class="text-xl">
              ...
              electricity. <br />
              We also provide the analytic tools such as price charts as well as
              simulations to give users a history of the grid state, and ultimately
        ...
        <div class="card card-side glass shadow-xl mt-4 min-h-72">
          ...
          <div class="card-body text-white">
            ...
            <p class="text-xl">
              The market platform is built on top of a accurate electrical grid
              simulation. <br />
              Our simulation takes the following into account:
        ...
        <!-- svelte-ignore a11y-no-static-element-interactions -->
        <div
          class="flex flex-col w-full my-8 pt-4 justify-center items-center"
          on:click={scrollUp}
        >
